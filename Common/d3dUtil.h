...
struct MeshGeometry
{
    ...
    {
        D3D12_VERTEX_BUFFER_VIEW vcbv;
        vcbv.BufferLocation = VertexColorBufferGPU->GetGPUVirtualAddress();
        vcbv.StrideInBytes = VertexColorByteStride;
        vcbv.SizeInBytes = VertexColorBufferByteSize;
